...
<body class="body-bg1">
    ...
    <div class="header-site-icon">
      <div class="slide-bar slide-bar1">
        <div class="sidebar-info">
          ...
          <div class="btn-area">
            <a href="contact.php" class="vl-btn3" style="overflow: hidden;">Get in touch now</a>
          </div>
          ...
          <div class="form-area">
            ...
            <form>
              ...
              <button type="submit" class="vl-btn3" style="overflow: hidden;">subscribe</button>
            </form>
          </div>
        </div>
      </div>
  ...
  <div class="hero4-section-area"
    style="background-image: url(assets/img/all-images/bg/hero-bg5.png); background-position: center top; background-repeat: no-repeat; background-size: cover;">
    <img src="assets/img/elements/elements27.png" alt="" class="elements27 aniamtion-key-1">
    <img src="assets/img/elements/elements28.png" alt="" class="elements28 aniamtion-key-3">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-7 m-auto">
          <div class="hero-header-area text-center">
            <img src="assets/img/elements/elements30.png" alt="" class="elements30 aniamtion-key-2">
            <h5><img src="assets/img/icons/sub-logo1.svg" alt=""> Designing the Future of Your Brand</h5>
            <div class="space32"></div>
            <h1 class="text-anime-style-3">Pixel-Perfect <img src="assets/img/elements/elements29.png" alt=""
                class="elements1 keyframe5"></h1>
            <div class="space40 d-md-block d-none"></div>
            <div class="space16 d-block d-md-none"></div>
            <h1 class="text-anime-style-3"><img src="assets/img/all-images/others/others-img3.png" alt=""
                class="others-img1"> Web Design</h1>
            <div class="space40"></div>
            <div class="btn-area1">
              <a href="project.php" style="overflow: hidden;" class="vl-btn3">Start Your Project Today</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="marquee-wrap">
      <div class="marquee-text">
        <div class="brand-single-box">
          <h3>SEO marketing <img src="assets/img/elements/elements5.png" alt=""></h3>
        </div>

        <div class="brand-single-box">
          <h3>Website Design <img src="assets/img/elements/elements5.png" alt=""></h3>
        </div>

        <div class="brand-single-box">
          <h3>Motion graphic <img src="assets/img/elements/elements5.png" alt=""></h3>
        </div>

        <div class="brand-single-box">
          <h3>Media Entertainment <img src="assets/img/elements/elements5.png" alt=""></h3>
        </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="images">
            ...
            <img src="assets/img/elements/elements31.png" alt="" class="elements8">
          </div>
        </div>

        <div class="col-lg-6">
          <div class="about-header heading3">
            <h5 data-aos="fade-left" data-aos-duration="800"><img src="assets/img/icons/sub-logo4.svg" alt="">Driven to
              the Creativity</h5>
            <div class="space20"></div>
            <h2 class="text-anime-style-3">Crafting Website with Purpose and Passions</h2>
            <div class="space16"></div>
            <p data-aos="fade-left" data-aos-duration="900">Our team of designers, developers, and strategists are
              passionate about bringing your brand’s vision to life through innovative user.</p>
            <div class="space32"></div>
            ...
            <div class="btn-area1" data-aos="fade-left" data-aos-duration="1100">
              <a href="contact.php" class="vl-btn3" style="overflow: hidden;">Schedule a Consultation</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="serve-section-area sp10">
      ...
      <div class="row">
        <div class="col-lg-4 m-auto">
          <div class="heading1 space-margin60 text-center">
            <h5 style="color: #fff;"><img src="assets/img/icons/sub-logo1.svg" alt="">Industries we serve</h5>
          </div>
        </div>
      </div>
    </div>
    <div class="slider5-section-area">
      <div class="marquee-wrap">
        <div class="marquee-text">
          <div class="brand-single-box">
            <h3><a href="service-single.php"><img src="assets/img/all-images/others/serve-img1.png" alt=""><span><i
                    class="fa-solid fa-arrow-right"></i></span>Business Consulting</a></h3>
          </div>

          <div class="brand-single-box">
            <h3><a href="service-single.php"><img src="assets/img/all-images/others/serve-img2.png" alt=""><span><i
                    class="fa-solid fa-arrow-right"></i></span>Medical Healthcare</a></h3>
          </div>

          <div class="brand-single-box">
            <h3><a href="service-single.php"><img src="assets/img/all-images/others/serve-img3.png" alt=""><span><i
  ...
  <div class="service4-section-area sp1"
    style="background-image: url(assets/img/all-images/bg/bg6.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 m-auto">
          <div class="heading3 text-center space-margin60">
            <h5><img src="assets/img/icons/sub-logo4.svg" alt=""> Excellence in Every Pixel</h5>
            <div class="space20"></div>
          ...
          <div class="service-tabs-area">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                  ...
                  <span class="icons"><img src="assets/img/icons/service1.svg" alt=""></span>
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
                  ...
                  <span class="icons"><img src="assets/img/icons/service2.svg" alt=""></span>
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact"
                  ...
                  <span class="icons"><img src="assets/img/icons/service3.svg" alt=""></span>
                  <span class="text">SEO Marketing</span>
                </button>
              </li>

              <li class="nav-item" role="presentation">
                <button class="nav-link m-0" id="pills-contact1-tab" data-bs-toggle="pill"
                  data-bs-target="#pills-contact1" type="button" role="tab" aria-controls="pills-contact1"
                  aria-selected="false">
                  <span class="icons"><img src="assets/img/icons/service4.svg" alt=""></span>
                  <span class="text">E-commerce Shop</span>
                </button>
              </li>
            </ul>
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                ...
                <div class="row">
                  <div class="col-lg-5">
                    <div class="service-heading heading3">
                      <h5><img src="assets/img/icons/sub-logo4.svg" alt=""> SEO Marketing</h5>
                      <div class="space16"></div>
                      <h2>Unlock the Power SEO to Grow Your Business</h2>
                      <div class="space16"></div>
                      <p>At SEOMAX, we specialize in helping businesses achieve top rankings on search engines through
                        effective SEO marketing of our team experts.</p>
                      <div class="space8"></div>
                      <ul>
                        <li><img src="assets/img/icons/check3.svg" alt=""> Increased Website Traffic</li>
                        <li><img src="assets/img/icons/check3.svg" alt=""> Cost-Effective Marketing</li>
                      </ul>
                      <div class="space32"></div>
                      <div class="btn-area1">
                        <a href="contact.php" class="vl-btn3" style="overflow: hidden;">Schedule a Consultation</a>
                  ...
                  <div class="col-lg-7">
                    ...
                    <div class="service-images">
                      ...
                      <img src="assets/img/elements/elements33.png" alt="" class="elements33 aniamtion-key-1">
                      <img src="assets/img/elements/elements34.png" alt="" class="elements34 aniamtion-key-2">
                      <img src="assets/img/elements/elements35.png" alt="" class="elements35">
                      <img src="assets/img/elements/elements36.png" alt="" class="elements36">
                    </div>
                    <div class="space50 d-lg-none d-block"></div>
                  </div>
                </div>
  ...
  <!--===== CASE AREA STARTS =======-->
  <div class="portfolio4-section-area sp6">
    <div class="container">
      <div class="row">
        <div class="col-lg-7">
          <div class="portfolio-header heading3 space-margin60">
            <h5><img src="assets/img/icons/sub-logo4.svg" alt="">Showcasing Our Impact</h5>
  ...
  <section class="testimonials-4 sp6"
    style="background-image: url(assets/img/all-images/bg/bg6.png); background-position: center; background-repeat: no-repeat; background-size: cover;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto text-center">
          <div class="heading3 space-margin60">
            <h5><img src="assets/img/icons/sub-logo4.svg" alt=""> Real Feedback</h5>
            <div class="space20"></div>
  ...
  <div class="slider6-section-area">
    <div class="marquee-wrap">
      <div class="marquee-text">
        <div class="brand-single-box">
          <h3>SEO marketing <img src="assets/img/elements/elements5.png" alt=""></h3>
  ...
  <!--===== CTA AREA STARTS =======-->
  <div class="cta-btn-area6 sp8">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="btn-area">
            <a href="contact.php" class="cta-btn1">Get In touch</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="vl-footer4-section-area sp8">
    <img src="assets/img/elements/elements32.png" alt="" class="elements6">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="vl-footer-widget">
            ...
            <ul>
              ...
              <li><a href="renevagency@com"><img src="assets/img/icons/email1.svg" alt="">renevagency@com</a></li>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="vl-footer-widget">
            ...
            <div class="space24"></div>
            <img src="assets/img/all-images/others/others-img4.png" alt="">
            <div class="space18"></div>
            <form>
              <input type="text" placeholder="Email">
              <button type="submit" class="vl-btn3">Subscribe</button>
            </form>
          </div>
        </div>
      </div>
