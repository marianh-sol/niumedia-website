      ...
      <div class="row align-items-center">
        <div class="col-lg-7">
          <div class="hero-header-area">
            ...
            <h4><a href="index.php">Home</a> <i class="fa-solid fa-angle-right"></i> <a href="#">testimonials</a></h4>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="testimonial-boxarea">
            ...
            <div class="space16"></div>
            <p>“Our website has completely transformed since design working with this team. They understood our vision
              the perfectly and brought it to life in a way that exceeded our expectations. The design is both beautiful
              and the.”</p>
            <div class="space32"></div>
            <div class="names-area">
              <div class="man-textarea">
        ...
        <div class="col-lg-6">
          <div class="testimonial-boxarea">
            ...
            <div class="space16"></div>
            <p>"Working with this team was a game-changer for our business. We came to them with a vision for a modern,
              user-friendly website, and they not only delivered but exceeded our expectations The best team’s
              attention”</p>
            <div class="space32"></div>
            <div class="names-area">
              <div class="man-textarea">
              ...
              <img src="assets/img/elements/elements22.png" alt="" class="elements20">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="testimonial-boxarea">
            ...
            <div class="space16"></div>
            <p>"We’ve worked with several web design agencies over the years, but none compare to the level of service
              and expertise we experienced here. From the initial design consultation to the final launch, the team was
              highly”</p>
            <div class="space32"></div>
            <div class="names-area">
              <div class="man-textarea">
              ...
              <img src="assets/img/elements/elements23.png" alt="" class="elements20">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="testimonial-boxarea">
            ...
            <div class="space16"></div>
            <p>"From day one, this agency has been a true partner in our digital journey. They understood our goals and
              to delivered a website that not only looks great but also functions flawlessly. The design is clean, on
              modern.”</p>
            <div class="space32"></div>
            <div class="names-area">
              <div class="man-textarea">
              ...
              <img src="assets/img/elements/elements24.png" alt="" class="elements20">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="testimonial-boxarea">
            ...
            <div class="space16"></div>
            <p>From day one, this agency has been a true partner in our digital journey. They understood our goals and
              the delivered a website that not only looks great but also functions flawlessly. The design is clean, on
              modern.”</p>
            <div class="space32"></div>
            <div class="names-area">
              <div class="man-textarea">
              ...
              <img src="assets/img/elements/elements25.png" alt="" class="elements20">
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="testimonial-boxarea">
            ...
            <div class="space16"></div>
            <p>This web design agency took our outdated site and of transformed it into a modern, mobile-friendly best
              to powerhouse. Their team provided invaluable guidance throughout the entire process, from on initial
              concept.”</p>
            <div class="space32"></div>
            <div class="names-area">
              <div class="man-textarea">
              ...
              <img src="assets/img/elements/elements26.png" alt="" class="elements20">
            </div>
          </div>
        </div>
