                                            ...
                                            <div class="row gx-4 row-cols-1 row-cols-md-1 row-cols-lg-4">
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index.php">RENEV - Homepage 01</a>
                                                        <div class="btn-area1">
                                                            <a href="index.php" class="vl-btn3">View Demo</a>
                                                ...
                                                <div class="col">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index2.php">RENEV - Homepage 02</a>
                                                        <div class="btn-area1">
                                                            <a href="index2.php" class="vl-btn3">View Demo</a>
                                                ...
                                                <div class="col ">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index3.php">RENEV - Homepage 03</a>
                                                        <div class="btn-area1">
                                                            <a href="index3.php" class="vl-btn3">View Demo</a>
                                                ...
                                                <div class="col ">
                                                    <div class="vl-home-thumb">
                                                        ...
                                                        <a href="index4.php">RENEV - Homepage 04</a>
                                                        <div class="btn-area1">
                                                            <a href="index4.php" class="vl-btn3">View Demo</a>
                ...
                <div class="col-lg-4 col-md-6 col-6">
                    <div class="vl-hero-btn d-none d-lg-block text-end">
                        ...
                        <span class="vl-btn-wrap text-end">
                            <a href="contact.php" class="vl-btn3" style="overflow: hidden;">Let’s Build Together</a>
                        </span>
